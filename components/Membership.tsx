        ...
        <div className='mx-6 sm:px-12 md:max-w-6xl md:mx-auto py-4 md:py-8'>
            ...
            memberDatas.map((memberData,index)=>(
                <div key={index}>
                    <div className='my-8 md:my-16 flex flex-col'>
                        <div className='flex justify-between items-center my-3'>
                            <div className='flex flex-col md:flex-row md:gap-3 items-start md:items-center'>
                                <h2 className='text-xl md:text-3xl text-[#090056] text-center md:text-left font-bold'>{memberData.memberType}</h2>
                                <p className='text-[#bababb] sm:text-md md:text-lg font-[400]'>Annual Subscription: <b className='text-[#090056]'>{memberData.price}</b></p>
                            </div>
                            <Button variant="ghost" className='text-md font-[400] hidden md:flex'>
                                <span>Apply</span>
                    ...
                    {memberDatas.length > (index + 1) && <div className='w-full h-[1px] bg-[#e2e2e3]'></div>}
                </div>
                ))
            }
        </div>
